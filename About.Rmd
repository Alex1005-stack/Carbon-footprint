...
This project aims to visualize the carbon footprint and resulting economic damage that an individual student leaves for the next generation of Harvard students through their participation in spending the Harvard endowment proceeds. Ideally I will be able to translate personalized specifications (time at school, current department, share of operations financed through endowment, etc.) into cost for a freshman starting in 25 years.
...
<b>IV. About Me:</b>
My name is Alexander Klueber. I am a Harvard Kennedy School student passionate about data science and transitioning our economies to a low carbon future. Contact me at alexander_klueber@hks.harvard.edu.
